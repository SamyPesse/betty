...
module.exports = {
    ...
    messages: {
        ...
        callConfirm: "Hi <%= member.name %>, we have an incoming call from <%= from %>, press 1 if you accept or the call",
        callRecord: "Thank you, your message has been recorded, our team will be get in touch with you soon",
